<template>
  <div class="container my-5 d-flex justify-content-center align-items-start" style="min-height: 100vh;">
    <div class="card text-center" style="width: 100%; max-width: 500px; background-color: #f9f9f9; border: 1px solid #e0e0e0;" role="region" aria-labelledby="receipt-title">
      <div class="card-body p-4">
        <h2 id="receipt-title" class="mb-4" style="color: #4a4a4a;">Donation Receipt</h2>
...
const fetchDonorInfo = async (id) => {
  ...
  if (docSnapshot.exists()) {
    ...
    alert('Donor information could not be found.'); 
  }
};
